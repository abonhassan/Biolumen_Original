...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function setupDots(containerSelector, dotSelector, itemSelector) {
    const container = document.querySelector(containerSelector);
    const dotWrapper = document.querySelector(dotSelector);
    const items = container?.querySelectorAll(itemSelector);
    if (!container || !dotWrapper || !items?.length) return;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    setupDots(".benefit_viewport", ".benefit-dots", ".benefit_item");
    setupDots(".explanation_viewport", ".explanation-dots", ".explanation_item");
  });
